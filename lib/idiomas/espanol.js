...
const smsRowner = () => { return `𝑬𝒔𝒕𝒆 𝑪𝒐𝒎𝒂𝒏𝒅𝒐 𝑷𝒖𝒆𝒅𝒆 𝑺𝒆𝒓 𝑼𝒔𝒂𝒅𝒐 𝑼𝒏𝒊𝒄𝒂𝒎𝒆𝒏𝒕𝒆 𝑷𝒐𝒓 𝑴𝒊 𝑪𝒓𝒆𝒂𝒅𝒐𝒓.` }//NUMERO DE BOT
const smsOwner = () => { return `𝑬𝒔𝒕𝒆 𝑪𝒐𝒎𝒂𝒏𝒅𝒐 𝑷𝒖𝒆𝒅𝒆 𝑺𝒆𝒓 𝑼𝒔𝒂𝒅𝒐 𝑼𝒏𝒊𝒄𝒂𝒎𝒆𝒏𝒕𝒆 𝑷𝒐𝒓 𝑴𝒊 𝑪𝒓𝒆𝒂𝒅𝒐𝒓.` }//OWNER
const smsMods = () => { return `𝑬𝒔𝒕𝒆 𝑪𝒐𝒎𝒂𝒏𝒅𝒐 𝑷𝒖𝒆𝒅𝒆 𝑺𝒆𝒓 𝑼𝒔𝒂𝒅𝒐 𝑼𝒏𝒊𝒄𝒂𝒎𝒆𝒏𝒕𝒆 𝑷𝒐𝒓 𝑴𝒊 𝑪𝒓𝒆𝒂𝒅𝒐𝒓.` }//MODERADORES
const smsPremium = () => { return `𝑬𝒔𝒕𝒆 𝑪𝒐𝒎𝒂𝒏𝒅𝒐 𝑷𝒖𝒆𝒅𝒆 𝑺𝒆𝒓 𝑼𝒔𝒂𝒅𝒐 𝑼𝒏𝒊𝒄𝒂𝒎𝒆𝒏𝒕𝒆 𝑷𝒐𝒓 𝑴𝒊 𝑪𝒓𝒆𝒂𝒅𝒐𝒓.` }//USUARIOS PREMIUM
const smsGroup = () => { return `𝑬𝒔𝒕𝒆 𝑪𝒐𝒎𝒂𝒏𝒅𝒐 𝑺𝒐𝒍𝒂𝒎𝒆𝒏𝒕𝒆 𝑷𝒖𝒆𝒅𝒆 𝑼𝒔𝒂𝒓𝒔𝒆 𝑬𝒏 𝑮𝒓𝒖𝒑𝒐𝒔.` }//PARA GRUPOS
const smsPrivate = () => { return `𝑬𝒔𝒕𝒆 𝑪𝒐𝒎𝒂𝒏𝒅𝒐 𝑺𝒐𝒍𝒂𝒎𝒆𝒏𝒕𝒆 𝑷𝒖𝒆𝒅𝒆 𝑼𝒔𝒂𝒓𝒔𝒆 𝑬𝒏 𝑬𝒍 𝑷𝒓𝒊𝒗𝒂𝒅𝒐 𝑫𝒆𝒍 𝑩𝒐𝒕.` }//AL PRIVADO
const smsAdmin = () => { return `𝑬𝒔𝒕𝒆 𝑪𝒐𝒎𝒂𝒏𝒅𝒐 𝑺𝒐𝒍𝒂𝒎𝒆𝒏𝒕𝒆 𝑷𝒖𝒆𝒅𝒆 𝑼𝒔𝒂𝒓𝒔𝒆 𝑷𝒐𝒓 𝑨𝒅𝒎𝒊𝒏𝒔 𝑫𝒆𝒍 𝑮𝒓𝒖𝒑𝒐.` }//ADMINS
const smsBotAdmin = () => { return `𝑷𝒂𝒓𝒂 𝑼𝒔𝒂𝒓 𝑬𝒔𝒕𝒆 𝑪𝒐𝒎𝒂𝒏𝒅𝒐 𝑵𝒆𝒄𝒆𝒔𝒊𝒕𝒐 𝑺𝒆𝒓 𝑨𝒅𝒎𝒊𝒏.` }//BOT CON ADMIN
const smsUnreg = () => { return `𝑯𝒆𝒚, 𝑼𝒏 𝑴𝒐𝒎𝒆𝒏𝒕𝒐\n𝑷𝒂𝒓𝒂 𝑼𝒔𝒂𝒓 𝑬𝒍 𝑩𝒐𝒕 𝑬𝒔 𝑵𝒆𝒄𝒆𝒔𝒂𝒓𝒊𝒐 𝑹𝒆𝒈𝒊𝒔𝒓𝒂𝒓𝒔𝒆, 𝑼𝒕𝒊𝒍𝒊𝒛𝒂 𝑬𝒍 𝑪𝒐𝒎𝒂𝒏𝒅𝒐 /𝙫𝙚𝙧𝙞𝙛𝙞𝙘𝙖𝙧` }//VERIFICAR
const smsRestrict = () => { return `𝑬𝒔𝒕𝒆 𝑪𝒐𝒎𝒂𝒏𝒅𝒐 𝑬𝒔𝒕𝒂 𝑫𝒆𝒔𝒉𝒂𝒃𝒊𝒍𝒊𝒕𝒂𝒅𝒐 𝑷𝒐𝒓 𝑴𝒊 𝑪𝒓𝒆𝒂𝒅𝒐𝒓.` }//RESTRINGIR COMANDO
...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE SHADOWS BOT 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR SHADOWS BOT 🐈`}
...
const smsBye = () => { return '*╔══════════════*\n*╟ @user*\n*╟ 𝑯𝒂𝒔𝒕𝒂 𝑵𝒖𝒏𝒄𝒂!!*\n*╚══════════════*'}
const smsSpromote = () => { return '*@user 𝑺𝒆 𝑺𝒖𝒎𝒂 𝑨𝒍 𝑮𝒓𝒖𝒑𝒐 𝑫𝒆 𝑨𝒅𝒎𝒊𝒏𝒔!!*'}
const smsSdemote = () => { return '*@user 𝑨𝒃𝒂𝒏𝒅𝒐𝒏𝒂 𝑬𝒍 𝑮𝒓𝒖𝒑𝒐 𝑫𝒆 𝑨𝒅𝒎𝒊𝒏𝒔!!*'}
const smsSdesc = () => { return '*𝑳𝒂 𝑵𝒖𝒆𝒗𝒂 𝑫𝒆𝒔𝒄𝒓𝒊𝒑𝒄𝒊𝒐𝒏 𝑬𝒔:*\n\n@desc'}
const smsSsubject = () => { return '*𝑬𝒍 𝑵𝒖𝒆𝒗𝒐 𝑵𝒐𝒎𝒃𝒓𝒆 𝑫𝒆𝒍 𝑮𝒓𝒖𝒑𝒐 𝑬𝒔:*\n\n@subject'}
const smsSicon = () => { return '*𝑺𝒆 𝑯𝒂 𝑴𝒐𝒅𝒊𝒇𝒊𝒄𝒂𝒅𝒐 𝒍𝒂 𝑰𝒎𝒂𝒈𝒆𝒏 𝑫𝒆𝒍 𝑮𝒓𝒖𝒑𝒐!!*'}
const smsSrevoke = () => { return '*𝑬𝒍 𝑵𝒖𝒆𝒗𝒐 𝑳𝒊𝒏𝒌 𝑫𝒆𝒍 𝑮𝒓𝒖𝒑𝒐 𝑬𝒔*\n\n*@revoke*'}
...
//_allantilink.js
const smsTextoYT = () => { return '𝙣𝙪𝙗𝙚 𝙗𝙤𝙩'} 
...
//handler.js
const smsCont1 = () => { return `*🔴 𝗖𝗢𝗠𝗔𝗡𝗗𝗢 DE 𝙣𝙪𝙗𝙚 𝙗𝙤𝙩 𝗙𝗔𝗟𝗟𝗔𝗡𝗗𝗢 🔴*`}
...
const smsCont18 = () => { return `hola soy nube bot, porfavor de no escribirme soy un bot, si gustas adquirir nube bot comunícate con mis dueños 
JHON: +52 55 9119 2358
MEL: +52 81 8200 6265
GRUPO: https://chat.whatsapp.com/G8Qk5uWiWSX6NNvE2DiE7q \n*${global.ig}*`}
...
const eGataCoins = () => { return '🐧PinguiCoins' }
const eGataTickers = () => { return '🎫 Pingui Tickers' } 
...
const smsConfi8 = () => { return `🐧 ⇢ *Este Chat no es un Grupo*`}
...
const smsMens1 = () => { return `Este Comando`} 
const smsMens2 = () => { return `Se Encuentra`} 
...
//_antiviewonce.js
const smsAntiView = () => { return `*Jaja Shadows Bot Lo Ve Todo*`} 
...
const smsContAdult = () => { return `${lenguajeGB['smsAvisoAG']()}*LOS COMANDOS 🔞 ESTÁN DESACTIVADOS, SI USTED ES MI CREADOR(A) USE #enable modohorny*`}
...
//info-contacto.js
const smsContacto1 = () => { return ''}
const smsContacto2 = () => { return ''}
const smsContacto3 = () => { return ''}
const smsContacto4 = () => { return 'Contacto Oficial de Shadows Bot'}
const smsContacto5 = () => { return ''}
const smsContacto6 = () => { return ''}
const smsContacto7 = () => { return ''}
const smsContacto8 = () => { return ''}
