...
//_autodetec.js
smsAutodetec1: (usuario, m) => `𝑺𝒉𝒂𝒅𝒐𝒘𝒔 𝑩𝒐𝒕 𝑨𝒗𝒊𝒔𝒐𝒔\n\n ${usuario} 𝑯𝒂 𝑪𝒂𝒎𝒃𝒊𝒂𝒅𝒐 𝑬𝒍 𝑵𝒐𝒎𝒃𝒓𝒆 𝑫𝒆𝒍 𝑮𝒓𝒖𝒑𝒐.\n\n𝑨𝒉𝒐𝒓𝒂 𝑺𝒆 𝑳𝒍𝒂𝒎𝒂 : ${m.messageStubParameters[0]}`, 
smsAutodetec2: (usuario, groupMetadata) => `𝑺𝒉𝒂𝒅𝒐𝒘𝒔 𝑩𝒐𝒕 𝑨𝒗𝒊𝒔𝒐𝒔\n\n» ${usuario} 𝑯𝒂 𝑪𝒂𝒎𝒃𝒊𝒂𝒅𝒐 𝑳𝒂 𝑰𝒎𝒂𝒈𝒆𝒏 𝑫𝒆𝒍 𝑮𝒓𝒖𝒑𝒐 \n𝑬𝒔𝒕𝒂 𝑬𝒔 𝑳𝒂 𝑵𝒖𝒆𝒗𝒂 𝑰𝒎𝒂𝒈𝒆𝒏 : ${groupMetadata.subject}`, 
smsAutodetec3: (usuario, m) => `𝑺𝒉𝒂𝒅𝒐𝒘𝒔 𝑩𝒐𝒕 𝑨𝒗𝒊𝒔𝒐𝒔\n\n» ${usuario} 𝑯𝒂 𝑪𝒂𝒎𝒃𝒊𝒂𝒅𝒐 𝑰𝒏𝒇𝒐 𝑫𝒆𝒍 𝑮𝒓𝒖𝒑𝒐 \n𝑨𝒉𝒐𝒓𝒂 𝑳𝒂 𝑰𝒏𝒇𝒐 𝑬𝒔  :`, 
...
smsAutodetec5: (groupMetadata, usuario) => `*𝑬𝒍 𝑳𝒊𝒏𝒌 𝑫𝒆  ${groupMetadata.subject} 𝑯𝒂 𝑺𝒊𝒅𝒐 𝑹𝒆𝒔𝒕𝒂𝒃𝒍𝒆𝒄𝒊𝒅𝒐 𝑷𝒐𝒓:*\n*» ${usuario}*`, 
smsAutodetec6: (m) => `𝑬𝒍 𝑮𝒓𝒖𝒑𝒐 𝑯𝒂 𝑺𝒊𝒅𝒐 ${m.messageStubParameters[0] == 'on' ? ' 𝑪𝒆𝒓𝒓𝒂𝒅𝒐' : '𝑨𝒃𝒊𝒆𝒓𝒕𝒐'}\n ${m.messageStubParameters[0] == 'on' ? '𝑺𝒐𝒍𝒂𝒎𝒆𝒏𝒕𝒆 𝑨𝒅𝒎𝒊𝒏𝒔 𝑷𝒖𝒆𝒅𝒆𝒏 𝑯𝒂𝒃𝒍𝒂𝒓' : '𝑨𝒉𝒐𝒓𝒂 𝑻𝒐𝒅𝒐𝒔 𝑷𝒖𝒆𝒅𝒆𝒏 𝑯𝒂𝒃𝒍𝒂𝒓'}`, 
smsAutodetec7: (m, usuario) =>  `𝑨𝒉𝒐𝒓𝒂 @${m.messageStubParameters[0].split`@`[0]} 𝑬𝒔 𝑨𝒅𝒎𝒊𝒏 𝑫𝒆𝒍 𝑮𝒓𝒖𝒑𝒐\n\n𝑨𝒄𝒄𝒊𝒐𝒏 𝑹𝒆𝒂𝒍𝒊𝒛𝒂𝒅𝒂 𝑷𝒐𝒓: ${usuario}`, 
smsAutodetec8: (m,  usuario) => `𝑨𝒉𝒐𝒓𝒂 @${m.messageStubParameters[0].split`@`[0]} 𝒀𝒂 𝑵𝒐 𝑬𝒔 𝑨𝒅𝒎𝒊𝒏 𝑫𝒆𝒍 𝑮𝒓𝒖𝒑𝒐\n\n𝑨𝒄𝒄𝒊𝒐𝒏 𝑹𝒆𝒂𝒍𝒊𝒛𝒂𝒅𝒂 𝑷𝒐𝒓: ${usuario}`, 
smsAutodetec9: (usuario, m) => `*» ${usuario}*\n*𝑯𝒂 𝑪𝒂𝒎𝒃𝒊𝒂𝒅𝒐 𝙇𝘼𝙎 𝘿𝙐𝙍𝘼𝘾𝙄𝙊𝙉 𝘿𝙀𝙇 𝙇𝙊𝙎 𝙈𝙀𝙉𝙎𝘼𝙅𝙀 𝙏𝙀𝙈𝙋𝙊𝙍𝘼𝙇𝙀𝙎 𝘼 : *@${m.messageStubParameters[0]}*`, 
...
//grupos
smsAdd: 'Hola! me presento, soy 𝑺𝒉𝒂𝒅𝒐𝒘𝒔 𝑩𝒐𝒕, soy un Bot de WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te unas al grupo, te esperamos con ansias!!', 
